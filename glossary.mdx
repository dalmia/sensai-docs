...
The admin panel is a dashboard that allows admins to manage the organization. The admin panel is accessible to admins only. You can open your admin panel by clicking on the `Manage Your Courses` button in the sidebar.
