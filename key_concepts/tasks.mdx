...
> List of coding languages supported
...
### Report
For tasks with `AI response type` as `Report`, AI will provide a report to the learner based on the scoring criteria provided by the educator.
...
> different variants (tags vs not tags, answers given vs not, etc.)
...
To edit one or more tasks, you need to first select the task (s) you want to edit.

### Edit a task

If you want to edit a single task, the task will be opened in edit mode. Apart from the task type, you can edit all the fields of the task.
