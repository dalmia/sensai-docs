...
If the code requires taking user inputs, learners are asked to provide the inputs when they run their code.
...
<AccordionGroup>
  ...
  <Accordion icon="pen-to-square" title="Bulk edit tasks">
    If you want to edit multiple tasks, a bulk edit form will open up. In bulk edit mode, you can edit the [Milestone](/key_concepts/milestones) and [Courses](/key_concepts/courses) that the tasks are assigned to.
